...
const features = [
  {
    ...
    description: "Aplicações web e sistemas sob medida, do frontend ao backend. Interfaces rápidas, escaláveis e centradas na experiência do usuário.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "APIs & Integrações",
    description: "Arquitetura de APIs robustas e integração entre sistemas. Conectamos ferramentas, plataformas e serviços para o seu negócio operar sem atritos.",
    visual: "collab",
  },
  {
    number: "03",
    title: "Automação & IA",
    description: "Automatização de processos e soluções com inteligência artificial que reduzem custo operacional e liberam seu time para o que importa.",
    visual: "ai",
  },
  {
    number: "04",
    title: "Cloud & Segurança",
    description: "Infraestrutura em nuvem, boas práticas de engenharia e segurança em todas as camadas. Código limpo, escalável e mantível.",
    visual: "security",
  },
];
